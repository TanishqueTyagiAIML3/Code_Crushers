...
define(['./workbox-9ba2d447'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url,
    request
  }) => request.method === "GET" && url.pathname.startsWith("/api/history"), new workbox.NetworkFirst({
  ...
  workbox.registerRoute(({
    url,
    request
  }) => request.method === "GET" && /^\/api\/(user-history|health|lessons|content)/i.test(url.pathname), new workbox.NetworkFirst({
